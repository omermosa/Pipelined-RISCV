...
set_property PACKAGE_PIN N17 [get_ports RiscV_clk]
set_property IOSTANDARD LVCMOS33  [get_ports RiscV_clk]
...
set_property PACKAGE_PIN U11 [get_ports {ssdSel[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ssdSel[3]}]

set_property PACKAGE_PIN U12 [get_ports {ssdSel[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ssdSel[2]}]

set_property PACKAGE_PIN H6 [get_ports {ssdSel[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ssdSel[1]}]

set_property PACKAGE_PIN T13 [get_ports {ssdSel[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ssdSel[0]}]

set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets RiscV_clk]
